...
def objective(trial:optuna.Trial):
    ...
    # config 設定
    config = EfficientNetConfig(model_framework="eeg_efficientnet_b0_v2",
                                batch_size = 2 ** 4,
    ...
    for fold, (train_indexs, val_indexs) in enumerate(
        ...
        score_dict_inner = runner.run_train(train_df, val_df, eegs_dir=eegs_dir, spectrograms_dir=spectrograms_dir,
                                            remove_temp_dir=False)
        score_dict["kaggle_score"] += score_dict_inner["kaggle_score"] / runner_config.fold_num
...
if __name__ == '__main__':
    ...
    model_name = "eeg_efficientnet_b0_v2"
    date = "20240330"
