...
@dataclass
class EEGResnetGRUConfig:

    model_framework: str = "ResnetGRU"
    data_use_second: int = 50
    batch_size: int = 2 ** 4
    accumulate_grad_batches: int = 2 ** 0  # この回数だけロスを蓄積してパラメータを更新する。
    learning_rate: float = 0.0021240608109281056
    weight_decay: float = 0.13802361074860534
    warmup_steps_ratio: float = 0.1
    max_epoch: int = 10
    num_worker: int = 0
    mix_up_alpha: float = 0.004652019816451542
    early_stop: bool = True

    drop_out: float = 0.031669150399141616
