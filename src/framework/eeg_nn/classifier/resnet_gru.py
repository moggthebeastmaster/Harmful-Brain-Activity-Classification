...
if __name__ == '__main__':
    ...
    from src.framework.eeg_nn.data.eeg_resnetgru_dataset import EEGResnetGRUDataset

    train_dataset = EEGResnetGRUDataset(meta_df, eegs_dir, config=config, with_label=True)
